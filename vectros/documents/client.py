...
class DocumentsClient:
    ...
    def get_document(self, id: str, *, request_options: typing.Optional[RequestOptions] = None) -> DocumentResponse:
        """
    ...
    def patch_document(
        ...
        *,
        ...
        """
        _response = self._raw_client.patch_document(
            id,
            title=title,
            text=text,
            index_mode=index_mode,
    ...
    def lookup_documents(
        ...
        *,
        ...
        """
        _response = self._raw_client.lookup_documents(
            type=type,
            field=field,
            value=value,
            from_=from_,
    ...
    def lookup_documents_by_body(
        ...
        *,
        ...
        """
        _response = self._raw_client.lookup_documents_by_body(
            type=type,
            field=field,
            value=value,
            from_=from_,
    ...
    def get_document_download_url(
        ...
        """
        _response = self._raw_client.get_document_download_url(id, request_options=request_options)
        return _response.data
    ...
    def get_document_text(
        ...
        """
        _response = self._raw_client.get_document_text(id, request_options=request_options)
        return _response.data
    ...
    def get_document_versions(
        ...
        *,
        ...
        """
        _response = self._raw_client.get_document_versions(id, start_from=start_from, request_options=request_options)
        return _response.data
...
class AsyncDocumentsClient:
    ...
    async def ingest_document(
        ...
        *,
        ...
        async def main() -> None:
            await client.documents.ingest_document(
                title="Patient Intake Form — Jane Doe",
            )
    ...
    async def patch_document(
        ...
        *,
        ...
        async def main() -> None:
            await client.documents.patch_document(
                id="id",
                title="Patient Intake Form — Jane Doe",
            )
        ...
        asyncio.run(main())
        """
        _response = await self._raw_client.patch_document(
            id,
            title=title,
            text=text,
            index_mode=index_mode,
    ...
    async def lookup_documents(
        ...
        *,
        ...
        async def main() -> None:
            await client.documents.lookup_documents(
                type="invoice",
                field="po_number",
                value="PO-1001",
                prefix="PO-2024",
        ...
        asyncio.run(main())
        """
        _response = await self._raw_client.lookup_documents(
            type=type,
            field=field,
            value=value,
            from_=from_,
    ...
    async def lookup_documents_by_body(
        ...
        *,
        ...
        async def main() -> None:
            await client.documents.lookup_documents_by_body(
                type="invoice",
                field="mrn",
            )
        ...
        asyncio.run(main())
        """
        _response = await self._raw_client.lookup_documents_by_body(
            type=type,
            field=field,
            value=value,
            from_=from_,
    ...
    async def get_document_download_url(
        ...
        async def main() -> None:
            await client.documents.get_document_download_url(
                id="id",
            )
        ...
        asyncio.run(main())
        """
        _response = await self._raw_client.get_document_download_url(id, request_options=request_options)
        return _response.data
    ...
    async def get_document_text(
        ...
        async def main() -> None:
            await client.documents.get_document_text(
                id="id",
            )
        ...
        asyncio.run(main())
        """
        _response = await self._raw_client.get_document_text(id, request_options=request_options)
        return _response.data
    ...
    async def get_document_versions(
        ...
        *,
        ...
        async def main() -> None:
            await client.documents.get_document_versions(
                id="6ba7b810-9dad-11d1-80b4-00c04fd430c8",
            )
        ...
        asyncio.run(main())
        """
        _response = await self._raw_client.get_document_versions(
