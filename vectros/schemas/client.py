    ...
    def list_schemas(
        ...
        *,
        ...
        scope : typing.Optional[str]
            Filter to schemas carrying this scope value, as a single `namespace:value` entry — for example `org:6ba7b810-9dad-11d1-80b4-00c04fd430c8` or `group:eng-team`. `org` and `client` are reserved namespace names; others are namespaces you registered yourself. Resolve a namespace's UUID from your own identifier with `GET /v1/entities/{namespace}?externalId=`.
